 ...
 *
 * SCCS: @(#) tkMacResource.r 1.33 97/08/13 16:55:08
 */
...
read 'TEXT' (2, "tk", purgeable, preload) "::library:tk.tcl";
read 'TEXT' (3, "button", purgeable, preload) "::library:button.tcl";
read 'TEXT' (4, "dialog", purgeable, preload) "::library:dialog.tcl";
read 'TEXT' (5, "entry", purgeable, preload) "::library:entry.tcl";
read 'TEXT' (6, "focus", purgeable, preload) "::library:focus.tcl";
read 'TEXT' (7, "listbox", purgeable, preload) "::library:listbox.tcl";
read 'TEXT' (8, "menu", purgeable, preload) "::library:menu.tcl";
read 'TEXT' (9, "optionMenu", purgeable, preload) "::library:optMenu.tcl";
read 'TEXT' (10, "palette", purgeable, preload) "::library:palette.tcl";
read 'TEXT' (11, "scale", purgeable, preload) "::library:scale.tcl";
read 'TEXT' (12, "scrollbar", purgeable, preload) "::library:scrlbar.tcl";
read 'TEXT' (13, "tearoff", purgeable, preload) "::library:tearoff.tcl";
read 'TEXT' (14, "text", purgeable, preload) "::library:text.tcl";
read 'TEXT' (15, "tkerror", purgeable, preload) "::library:bgerror.tcl";
read 'TEXT' (16, "Console", purgeable, preload) "::library:console.tcl";
read 'TEXT' (17, "msgbox", purgeable, preload) "::library:msgbox.tcl";
read 'TEXT' (18, "comdlg", purgeable, preload) "::library:comdlg.tcl";
read 'TEXT' (19, "prolog", purgeable, preload) "::library:prolog.ps";
