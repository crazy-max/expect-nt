...
extern TkClassProcs BltpButtonProcs;
extern Tk_ConfigSpec BltpButtonConfigSpecs[];
...
EXTERN void		BltButtonWorldChanged _ANSI_ARGS_((
			    ClientData instanceData));
EXTERN void		BltpComputeButtonGeometry _ANSI_ARGS_((
			    BltButton *butPtr));
EXTERN BltButton *	BltpCreateButton _ANSI_ARGS_((Tk_Window tkwin));
#ifndef TkpDestroyButton
#define TkpDestroyButton BltpDestroyButton
EXTERN void 		BltpDestroyButton _ANSI_ARGS_((BltButton *butPtr));
#else
#define BltpDestroyButton TkpDestroyButton
#endif
#ifndef TkpDisplayButton
#define TkpDisplayButton BltpDisplayButton
EXTERN void		BltpDisplayButton _ANSI_ARGS_((ClientData clientData));
#else
#define BltpDisplayButton TkpDisplayButton
#endif
